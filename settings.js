...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~FiNyhQ7J#3tnukhBLD14C7PxfnHm7J5-p2w-q9Rc0bI9hu3Ss7JA",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || "-",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "ᴍᴀʟᴠɪɴ-xᴅ",
// add bot name here for menu
MODE: process.env.MODE || "inbox-group",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "5532998665591",
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "5532998665591",
